<template>
  <div>
    ...
    <div class="login">
      <el-card>
        <el-divider content-position="center"><span style="font-size:0.3rem; color:rgba(56,149,191,1)">登录访问内部资源</span>
        </el-divider>
    ...
    async onSubmit(values) {
      ...
      if (this.type == 'login') {
        ...
        await axios.post('/login', formData).then(res => {
          ...
          // console.log('token:', res.JSESSIONID)
          // 登录成功,将token保存到本地,
...
.van-button--primary, .van-button--primary.is-active, .van-button--primary:active {
