<template>
  <div>
    ...
    <div class="apps">
      <div class="singe-app" v-for="app in group_applicationList" v-bind:key="app.name">
        <div>
        <span>{{ app.name }}
        </span>
    ...
    <div class="apps">
      <div class="singe-app" v-for="app in self_applicationList" v-bind:key="app.name">
        <div>
        <span>{{ app.name }}
        </span>
          <img :src="app.imgUrl" alt="">
